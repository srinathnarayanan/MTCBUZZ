package com.myfirstapp.cardsui;
...
import com.example.mtcbuzz.R;
import com.myfirstapp.cardsui.SwipeDismissTouchListener.OnDismissCallback;
        ...
        for (int i = 0; i < cardsArraySize; i++) {
            ...
            if (swipable) {
                cardView.setOnTouchListener(
                		new SwipeDismissTouchListener(cardView, card,
